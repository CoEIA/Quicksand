...
typedef unsigned char JHcompression_BitSequence;
typedef unsigned long long JHcompression_DataLength;
typedef enum {JHcompression_SUCCESS = 0, JHcompression_FAIL = 1, JHcompression_BAD_HASHLEN = 2} JHcompression_HashReturn;
...
void E8(JHcompression_hashState *state);   /*The bijective function E8, in bitslice form */
void F8(JHcompression_hashState *state);   /*The compression function F8 */

/*The API functions*/
JHcompression_HashReturn JHcompression_Init(JHcompression_hashState *state, int hashbitlen);
JHcompression_HashReturn JHcompression_Update(JHcompression_hashState *state, const JHcompression_BitSequence *data, JHcompression_DataLength databitlen);
JHcompression_HashReturn JHcompression_Final(JHcompression_hashState *state, JHcompression_BitSequence *hashval);
JHcompression_HashReturn JHcompression_Hash(int hashbitlen, const JHcompression_BitSequence *data,JHcompression_DataLength databitlen, JHcompression_BitSequence *hashval);
...
void E8(JHcompression_hashState *state)
{
...
void F8(JHcompression_hashState *state)
{
      uint32 i;
...
JHcompression_HashReturn JHcompression_Update(JHcompression_hashState *state, const JHcompression_BitSequence *data, JHcompression_DataLength databitlen)
{
      JHcompression_DataLength index; /*the starting address of the data to be compressed*/
...
JHcompression_HashReturn JHcompression_Hash(int hashbitlen, const JHcompression_BitSequence *data,JHcompression_DataLength databitlen, JHcompression_BitSequence *hashval)
{
      JHcompression_hashState state;

      if ( hashbitlen == 224 || hashbitlen == 256 || hashbitlen == 384 || hashbitlen == 512 ) {
            JHcompression_Init(&state, hashbitlen);
            JHcompression_Update(&state, data, databitlen);
            JHcompression_Final(&state, hashval);
            return JHcompression_SUCCESS;
      }
      else
            return(JHcompression_BAD_HASHLEN);
}
