#include "include/jh_ansi_opt32.h"
...
double benchmark_JHcompression_256(uint8_t *input, uint64_t input_len, int number_of_tests){
...
int main(){
    ...
    for(int i=8; i< 9; i++){
        ...
        groestl_time = benchmark_JHcompression_256(input, input_len[i], number_of_tests);
        printf("JHcompression_256  time: "GRN"%f"reset"\n", groestl_time);
