...
/********************************************************************************** 
 * Header file for the 32 bits optimized ansi C implementation of the ECHO hash 
 * function proposal.
...
typedef unsigned char echo_BitSequence;
typedef unsigned long long echo_DataLength;
typedef enum { 
  echo_SUCCESS=0
 ,echo_FAIL=1
 ,echo_BAD_HASHBITLEN=2
